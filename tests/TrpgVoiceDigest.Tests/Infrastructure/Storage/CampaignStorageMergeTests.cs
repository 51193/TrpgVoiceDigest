...
public class CampaignStorageMergeTests
{
    [Fact]
    public void Merge_ConsecutiveSameSpeaker()
    {
        ...
        var result = CampaignStorage.MergeConsecutiveSpeakerLines(input);
    ...
    {
        var result = CampaignStorage.MergeConsecutiveSpeakerLines("");
        Assert.Empty(result);
    }
